...
const Footer: React.FC = () => {
  ...
  useEffect(() => {
    if (infoRef.current) {
      infoRef.current?.style.setProperty("top", `${window.innerHeight / 2}px`);
    }
  }, [infoRef, scrollY]);

  return (
    <footer className="bg-slate-200 dark:bg-slate-700	h-lvh font-['DungGeunMo']">
      <div ref={infoRef} className={`flex w-full justify-center sticky pt-4`}>
          ...
          <div className="flex justify-center">
            <a href="https://github.io/6lueparr0t" target="_blank" rel="noopener noreferrer">
              <div className="flex items-center gap-2">
                <svg ref={svgRef} viewBox="0 0 16 16" width="16px" height="16px">
                  <path
                    fill="#828282"
